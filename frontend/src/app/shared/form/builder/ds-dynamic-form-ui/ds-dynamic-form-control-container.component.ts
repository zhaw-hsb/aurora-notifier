...
import { DsDynamicLookupExtendedComponent } from 'src/themes/zhaw/app/zhaw-shared/form/builder/ds-dynamic-form-ui/models/lookup/dynamic-lookup-extended.component';
...
export function dsDynamicFormControlMapFn(model: DynamicFormControlModel): Type<DynamicFormControl> | null {
  switch (model.type) {
    ...
    case DYNAMIC_FORM_CONTROL_TYPE_LOOKUP_NAME:
      /**ZHAW HSB-1724_Autorenmail: Button neben Autoren (in Eingabemaske im Workflow) für Mailversand */
